...
SCENARIOS: dict[str, dict] = {
    ...
    "welcome": {
        ...
        "problem": (
            "New users need to see what a War Room agent meeting looks like "
            "without installing anything external."
        ),
        "deliverable": (
            "a three-minute demo that shows intro, dialog, handoff, and outro."
        ),
        "why_assigned": {
            "research": (
            ...
            "strategist": (
                "Hi, I'm Memo. I'm here to show how a strategist reframes research into "
                "actionable positions."
            ),
            "writer": (
                "Hi, I'm Hermes. I'm here to demonstrate how decisions turn into clean, "
                "shippable tickets."
            ),
        },
        "turns": [
            {"kind": "intro", "agent": "narrator", "voice": VOICES["narrator"],
             "delay_ms": 200, "message": None,
             "reasoning": "Framing the demo and the roster."},

            {"kind": "speak", "agent": "research", "voice": VOICES["research"],
             "delay_ms": 500,
            ...
            {"kind": "speak", "agent": "strategist", "voice": VOICES["strategist"],
             "delay_ms": 400,
            ...
            {"kind": "handoff", "agent": "strategist", "voice": VOICES["strategist"],
             "delay_ms": 200,
             "message": "Over to you, Hermes."},

            {"kind": "speak", "agent": "writer", "voice": VOICES["writer"],
             "delay_ms": 400,
            ...
            {"kind": "outro", "agent": "narrator", "voice": VOICES["narrator"],
             "delay_ms": 500, "message": None,
    ...
    "nervix-marketplaces": {
        ...
        "agents":  ["research", "strategist", "writer"],
        "problem": (
            "NERVIX needs a sharp, defensible position in the open-source agent "
            "marketplace landscape before launch."
        ),
        "deliverable": (
            "a positioning note and a Paperclip ticket for the landing page rewrite."
        ),
        "why_assigned": {
            "research": (
    ...
    "telemetry-stack": {
        ...
        "deliverable": (
            "a Langfuse-plus-OpenTelemetry architecture and an implementation ticket for David."
        ),
        "why_assigned": {
            "research": (
        ...
        "turns": [
            ...
            # ---- architect answers --------------------------------------
            {"kind": "speak", "agent": "architect", "voice": VOICES["architect"],
             "delay_ms": 350,
            ...
            # ---- handoff ------------------------------------------------
            {"kind": "handoff", "agent": "architect", "voice": VOICES["architect"],
             "delay_ms": 200,
    ...
    "api-design-review": {
        ...
        "deliverable": (
            "an OpenAPI 3.1 spec, a versioning policy, and a ticket for the gateway team."
        ),
        "why_assigned": {
            "research": (
    ...
    "launch-readiness": {
        ...
        "deliverable": (
            "a go/no-go decision with a ranked hot-fix list and an owner for each item."
        ),
        "why_assigned": {
            "research": (
    ...
    "crawdbot-pricing": {
        ...
        "deliverable": (
            "a three-tier pricing model and a ticket for the pricing page rewrite."
        ),
        "why_assigned": {
            "research": (
